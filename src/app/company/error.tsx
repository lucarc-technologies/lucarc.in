...
export default function Error({
  ...
  useEffect(() => {
    console.error('[Lucarc/Company] Route error:', error);
  }, [error]);
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center space-y-8">
        ...
        <div className="space-y-3">
          <p className="text-xs font-mono uppercase tracking-widest text-primary">Company Page Error</p>
          <h1 className="text-2xl sm:text-3xl font-bold text-text font-heading">
            Failed to Load
          </h1>
          <p className="text-sm text-text-secondary leading-relaxed">
            This company page couldn&apos;t be loaded. Please try again.
            {error.digest && (
